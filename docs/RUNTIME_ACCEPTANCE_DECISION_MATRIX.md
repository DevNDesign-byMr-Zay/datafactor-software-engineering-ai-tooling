...
The helper also does not retrieve or validate the prior fingerprint. That state belongs to the consumer, which must decide whether the prior observation is trusted enough to compare.
