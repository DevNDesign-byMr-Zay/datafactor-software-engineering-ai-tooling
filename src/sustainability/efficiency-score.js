export function calculateSustainabilityEfficiency({ durationMs, estimatedEnergyWh, renewableRatio = 0 } = {}) {
  ...
  const energyPerSecond = durationMs === 0 ? 0 : estimatedEnergyWh / (durationMs / 1000);
