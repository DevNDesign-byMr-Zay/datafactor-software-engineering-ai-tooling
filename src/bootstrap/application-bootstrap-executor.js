...
/**
 * Execute an already-validated two-package application bootstrap plan in its
 * declared startup order. Every completed/started step is retained as evidence,
 * and execution stops on the first failure instead of guessing a recovery path.
 */
...
/**
 * Build a concrete Node process adapter. Install/build phases use execFile;
 * long-lived run phases use startProcessImpl so service startup does not block
 * waiting for the process to exit. Working directories remain role-specific.
 */
