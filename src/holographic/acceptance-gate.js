...
export function evaluateHolographicAcceptance({ envelope, scene, sceneFingerprint, snapshotId, sceneId, provenanceRef } = {}) {
  ...
  return Object.freeze({ accepted: provenanceValid && fingerprintValid && safetyValid, provenanceValid, fingerprintValid, safetyValid, authoritative: false, physicalActuation: false, advisoryOnly: true });
}
